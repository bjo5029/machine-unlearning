...
from run_experiment import run_experiment, load_or_train_original
from data_es import (
...
def main(args):
    ...
    methods_to_score = ["memorization", "es", "c_proxy", "random"]
    ...
    for i, exp_params in enumerate(all_experiments, 1):
        ...
        if run_config.get('use_retain_ordering'):
