...
CONFIG = {
    ...
    # --- 언러닝 공통 설정 ---
    "unlearn_epochs": 10, # 최종 실험 시에는 10으로 변경
    "unlearn_lr": 0.01,
    ...
    # ===================== 각 메소드별 상세 파라미터 ===========================
    "method_params": {
        "FT": { "unlearn_epochs": 10 }, # 테스트 시에는 1로 변경
        "FT_l1": { "unlearn_epochs": 10, "unlearn_lr": 0.005, "alpha": 1e-5 },
        "GA": { "unlearn_epochs": 10, "unlearn_lr": 1e-4 },
        "NG": { "unlearn_epochs": 5, "alpha": 0.9 },
        "RL": { "unlearn_epochs": 10 },
        "Wfisher": { "alpha": 10.0 },
        "SCRUB": { "unlearn_epochs": 10, "kd_T": 4.0, "gamma": 1.0, "beta": 1.0, "msteps": 5 }
    },
    # "method_params": {
